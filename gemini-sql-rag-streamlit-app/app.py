...
# def display_chat(agent_executor):
    """
    ...
    with container:
        ...
        if submit_button and user_input:
            ...
            # generate_response(user_input, agent_executor)
...
# def generate_response(user_input, agent_executor):
    """
    ...
    with st.spinner('Spinning a snazzy reply...'):
        ...
        # output = conversation_chat(user_input, agent_executor, st.session_state['history'])
...
# def conversation_chat(user_input, agent_executor, history):
    """
...
def main():
    ...
    # agent_executor = utils.create_conversational_chain()

    #Step 3 - Display Chat to Web UI
    display_chat(conversation_chain, chain)
    # display_chat(agent_executor)
